...
export default function BookSummariesTab() {
  const bookSummaries = useSelector(store => store.achievements.allAchievementsReducer.bookSummaries)
  console.log('bookSummaries:', bookSummaries);
  ...
  return (
    <>
      <h2>Book Summaries Achievements</h2>
      <Grid container spacing={2}>
        {bookSummaries.map((achievement, index) => {
          return (
